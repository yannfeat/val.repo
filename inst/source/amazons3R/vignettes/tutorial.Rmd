...
## Analyzing Amazon S3 marketing data 

Now we can analyze data from Amazon S3 data. For instance, let's compare the two campaigns we have to see which one performed better the last 100 days. 
