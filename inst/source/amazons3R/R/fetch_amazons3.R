#' fetch_amazons3
#' A function to fetch Amazon S3 data from the windsor.ai API
#'
...
#' @examples
#' \dontrun{
#' my_amazons3_data <- fetch_amazons3(api_key = "your api key",
...
fetch_amazons3 <-
  function(api_key,
    ...
    json_data <- jsonlite::fromJSON(
      paste0(
          "https://connectors.windsor.ai/amazon_s3?api_key=",
        api_key,
        "&fields=",
