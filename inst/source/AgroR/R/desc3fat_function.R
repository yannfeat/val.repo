...
desc3fat=function(f1,
  ...
  xlab=c(gsub(" ","~",xlab[1]),gsub(" ","~",xlab[2]),gsub(" ","~",xlab[3]))
  f1=as.factor(f1)
  f2=as.factor(f2)
  f3=as.factor(f3)
  ...
  grafico=ggplot(dados,aes(x=f1,y=response, fill=f2))+
    ...
    geom_boxplot()+xlab(parse(text=xlab[1]))+labs(fill=parse(text=xlab[2]))+
    ylab(parse(text=ylab))+theme+facet_wrap(~f3)
  grafico=grafico+
  ...
  grafico=ggplot(dados,aes(x=f1,y=response, color=f2))+
    ...
    ylab(parse(text=ylab))+xlab(parse(text=xlab[1]))+labs(color=parse(text=xlab[2]))+theme+facet_wrap(~f3)
  grafico=grafico+
    theme(text = element_text(size=12,color="black"),
          axis.title = element_text(size=12,color="black"),
          axis.text = element_text(size=12,color="black"),
