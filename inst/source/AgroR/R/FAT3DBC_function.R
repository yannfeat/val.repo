...
FAT3DBC=function(f1,
  ...
  fator1=f1
            ...
            if(quali[i]==FALSE && anavaF3[i,5]<=alpha.f){
              ...
              cat(green(bold("\n------------------------------------------\n")))
                ...
                grafico=polynomial(dose,resp,grau = grau[i],
                                   DFres= anavaF3[9,1],SSq = anavaF3[9,2],ylab=ylab,xlab=parse(text = lab.factor[i]),point = point)[[1]]
                ...
                i<-3
                {
                    ...
                    if(quali[i]==FALSE && anavaF3[i,5]<=alpha.f){
                        ...
                        grafico1=polynomial(resp, fatores[,i],grau=grau[i],
                                            DFres= anavaF3[9,1],SSq = anavaF3[9,2],ylab=ylab,xlab=parse(text = lab.factor[3]),point = point)[[1]]
                        cat(green("\nTo edit graphical parameters, I suggest analyzing using the \"polynomial\" command"))}
                }
            }
                ...
                i<-2
                {
                    ...
                    if(quali[i]==FALSE && anavaF3[i,5]<=alpha.f){
                        ...
                        grafico2=polynomial(resp, fatores[,i],grau=grau[i],
                                            DFres= anavaF3[9,1],SSq = anavaF3[9,2],ylab=ylab,xlab=parse(text = lab.factor[2]),point = point)[[1]]
                        cat(green("\nTo edit graphical parameters, I suggest analyzing using the \"polynomial\" command"))
                    }
                ...
                i<-1
                {
                    ...
                    if(quali[i]==FALSE && anavaF3[i,5]<=alpha.f){
                        ...
                        grafico3=polynomial(resp, fatores[,i],grau=grau[i],
                                            DFres= anavaF3[9,1],SSq = anavaF3[9,2],ylab=ylab,xlab=parse(text = lab.factor[1]),point = point)[[1]]
                        cat(green("\nTo edit graphical parameters, I suggest analyzing using the \"polynomial\" command"))
                    }
            ...
            for(j in 1:nv3) {
                ...
                if(quali[1]==FALSE){
                    ...
                    polynomial(fatores[,1][Fator2==lf2[i] & Fator3==lf3[j]],
                               ...
                               grau=grau123,
                               DFres= anavaF3[9,1],SSq = anavaF3[9,2],ylab=parse(text=ylab),xlab=parse(text = lab.factor[1]),point = point)[[1]]}
                }
        }
    ...
    if(anavaF3[8,5]>alpha.f && anavaF3[6,5]<=alpha.f && anavaF3[7,5]<=alpha.f){
        ...
        graficos}
    if(anavaF3[8,5]>alpha.f && anavaF3[5,5]<=alpha.f && anavaF3[6,5]<=alpha.f && anavaF3[7,5]<=alpha.f){
