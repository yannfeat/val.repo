...
FAT3DBC.ad = function(f1,
    ...
    for(i in 1:3){
      ...
      if(quali[i]==FALSE && anavaF3[i,5]<=alpha.f){
        ...
        grafico=polynomial(dose,resp,grau = grau[i],
                           DFres= anavaF3[10,1],SSq = anavaF3[10,2],ylab = ylab,xlab = parse(text = lab.factor[i]),point = point)[[1]]
    ...
    if(quali[1]==FALSE | quali[2]==FALSE){
      ...
      if(quali[1]==FALSE){
        ...
        colint1=polynomial2(Fator1a,
                            ...
                            theme=theme,
                            DFres= anavaF3[10,1],SSq = anavaF3[10,2])$plot}
      if(quali[2]==FALSE){
        if (mcomp == "tukey"){
          for (i in 1:nv2) {
            trati=fatores[, 1][Fator2 == lf2[i]]
    ...
    if(anavaF3[6,5]>alpha.f && anavaF3[7,5]>alpha.f) {
      ...
      if(quali[i]==FALSE && anavaF3[i,5]<=alpha.f){
        ...
        grafico1=polynomial(resp, fatores[,i],grau=grau[i],
                            DFres= anavaF3[10,1],SSq = anavaF3[10,2],ylab = ylab,xlab = parse(text = lab.factor[3]),point = point)[[1]]
        cat(green("\nTo edit graphical parameters, I suggest analyzing using the \"polynomial\" command"))}
    }
  }
      ...
      i<-2
      {
        ...
        if(quali[i]==FALSE && anavaF3[i,5]<=alpha.f){
          ...
          grafico2=polynomial(resp, fatores[,i],grau=grau[i],
                              DFres= anavaF3[10,1],SSq = anavaF3[10,2],ylab = ylab,xlab = parse(text = lab.factor[2]),point = point)[[1]]
          cat(green("\nTo edit graphical parameters, I suggest analyzing using the \"polynomial\" command"))
        }
      ...
      i<-1
      {
        ...
        if(quali[i]==FALSE && anavaF3[i,5]<=alpha.f){
          ...
          grafico3=polynomial(resp, fatores[,i],grau=grau[i],
                              DFres= anavaF3[10,1],SSq = anavaF3[10,2],ylab = ylab,xlab = parse(text = lab.factor[1]),point = point)[[1]]
          cat(green("\nTo edit graphical parameters, I suggest analyzing using the \"polynomial\" command"))
        }
      ...
      for(j in 1:nv3) {
        ...
        if(quali[1]==FALSE){
          ...
          polynomial(fatores[,1][Fator2==lf2[i] & Fator3==lf3[j]],
                     ...
                     DFres= anavaF3[10,1],SSq = anavaF3[10,2],ylab = parse(text=ylab),xlab = parse(text = lab.factor[1]),point = point)[[1]]}
      }
    }
      ...
      for(j in 1:nv3) {
        ...
        if(quali[2]==FALSE){
          ...
          polynomial(fatores[,2][Fator1==lf1[k] & fatores[,3]==lf3[j]],
                     ...
                     DFres= anavaF3[10,1],SSq = anavaF3[10,2],ylab = parse(text=ylab),xlab = parse(text = lab.factor[2]),point = point)[[1]]}
      }
    }
      ...
      for(i in 1:nv2) {
        ...
        if(quali[3]==FALSE){
          ...
          polynomial(fatores[,3][fatores[,1]==lf1[k] & fatores[,2]==lf2[i]],
                     ...
                     DFres= anavaF3[10,1],SSq = anavaF3[10,2],ylab = parse(text=ylab),xlab = parse(text = lab.factor[3]),point = point)[[1]]}
      }
    }
  ...
  if(anavaF3[7,5]>alpha.f && anavaF3[5,5]<=alpha.f && anavaF3[6,5]<=alpha.f && anavaF3[7,5]<=alpha.f){
