...
#' \ifelse{html}{\code{\link[aldvmm]{aldvmm}}}{\code{aldvmm()}} plus additional 
#' attributes, including an object of class "terms" derived from 
#' 'formula'.
#' @param Formula an object of class "Formula" created by 
#' \ifelse{html}{\code{\link[Formula]{Formula}}}{\code{Formula::Formula}} based 
#' on the \code{formula} supplied to 
