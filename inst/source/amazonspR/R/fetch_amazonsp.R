#' fetch_amazonsp
#' A function to fetch Amazon Sp data from the windsor.ai API
#'
...
#' @examples
#' \dontrun{
#' my_amazonsp_data <- fetch_amazonsp(api_key = "your api key",
...
fetch_amazonsp <-
  function(api_key,
    ...
    json_data <- jsonlite::fromJSON(
      paste0(
        "https://connectors.windsor.ai/amazon_sp?api_key=",
        api_key,
        "&fields=",
